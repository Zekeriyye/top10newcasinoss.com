export const siteConfig = {
  ...
  casinos: [
    ...
    },
    {
      ...
      bonus: "Welcome offer: 777% up to $11,250 + 20% cashbcak",
      rating: 8.4,
      playLink: "https://go.afftrackio.com/visit/?bta=35684&nci=5354&utm_campaign=MadCasino-CXUK01&afp="
    },

    {
      name: "DraculaCasino",
      logo: "dracula.png", // Change this filename to switch logos
      bonus: "Slots welcome Package 777% up to $11,665.50 + 20% cashback Wager: 25x",
      rating: 8.2,
  ...
  // Contact information
  contact: {
    email: "support@winningcasino.org"
  }
};
