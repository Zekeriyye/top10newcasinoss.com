          ...
          <div className="prose prose-invert max-w-none">
            <div className="bg-[#1A1A2E] border border-[#8B5CF6]/30 rounded-xl p-8 mb-8">
              ...
              <p className="text-gray-300 leading-relaxed">
                Our team comprises experienced gambling industry specialists who know the UK market, 
                UK Gambling Commission regulatory requirements, and British player needs. We've personally tested every UK-licensed casino we showcase, 
                from registration and funding to game play and withdrawals.
              </p>
            </div>
