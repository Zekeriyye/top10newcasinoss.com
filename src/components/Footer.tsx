      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-8 border-b border-[#FF6B35]/20">
          ...
          <p className="text-gray-300 text-sm max-w-2xl leading-relaxed">
            Your reliable resource for UK Gambling Commission licensed online casinos. We deliver impartial assessments and comparisons exclusively for UK-licensed casinos to assist British players in discovering secure, regulated casino sites.
          </p>
        </div>
