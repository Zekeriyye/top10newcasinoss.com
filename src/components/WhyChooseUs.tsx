export default function WhyChooseUs() {
  return (
    <section className="py-16 bg-[#0A0A0F] border-y border-[#FF6B35]/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4 bg-[#151520] border border-[#FF6B35]/20 rounded-xl p-5 hover:border-[#FF6B35]/40 transition-all">
              <div className="w-10 h-10 bg-gradient-to-br from-[#FF6B35] to-[#FF8C42] rounded-full flex items-center justify-center flex-shrink-0 shadow-lg">
          ...
          {/* Right Column - Stats */}
          <div className="bg-gradient-to-br from-[#151520] to-[#1A1A2E] border border-[#FF6B35]/30 rounded-xl p-8 shadow-xl">
            <h3 className="text-white font-bold text-xl mb-6 text-center">Our Track Record</h3>
            <div className="grid grid-cols-2 gap-6">
              <div className="text-center">
                <div className="text-4xl font-bold bg-gradient-to-r from-[#FF6B35] to-[#FFD700] bg-clip-text text-transparent mb-2">100%</div>
                <div className="text-gray-300 text-sm">UK Licensed Casinos</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold bg-gradient-to-r from-[#FF6B35] to-[#FFD700] bg-clip-text text-transparent mb-2">50K+</div>
                <div className="text-gray-300 text-sm">Players Helped</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold bg-gradient-to-r from-[#FF6B35] to-[#FFD700] bg-clip-text text-transparent mb-2">24/7</div>
                <div className="text-gray-300 text-sm">Support Available</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold bg-gradient-to-r from-[#FF6B35] to-[#FFD700] bg-clip-text text-transparent mb-2">5★</div>
